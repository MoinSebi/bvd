...
//             let mut _all_trav = "".to_owned();
//             let mut _all_interval = "".to_owned();
//             let mut _all_bubble = "".to_owned();
//             let mut intervals = 0;
//             let mut bub ;
//
//
...
pub fn write_traversal(input: &Vec<(&[u32], &[bool])>, bubble_id: u32) -> String{
    ...
    for (_index, traversal) in input.iter().enumerate(){
        let mut v = Vec::new();
